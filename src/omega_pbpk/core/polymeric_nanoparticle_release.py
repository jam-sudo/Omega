...
_POLYMER_PARAMS = {
    ...
    "chitosan": {"burst_pct": 25.0, "k_diffusion": 0.015, "k_erosion": 0.0,   "mechanism": "diffusion"},
...
def _build_notes(polymer_type, mechanism, burst_fraction_pct, t50_h, t80_h,
                 particle_size_nm, release_class):
    return (
...
def simulate_nanoparticle_release(
    ...
    notes = _build_notes(
        polymer_type, mechanism, burst_fraction_pct, t50_h, t80_h,
        particle_size_nm, release_class
    )
