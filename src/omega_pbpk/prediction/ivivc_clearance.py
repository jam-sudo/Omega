...
def _well_stirred(
    ...
    """
    return qh_mL_per_min_per_kg * cl_int_scaled_mL_per_min_per_kg / (
...
def _parallel_tube(
    ...
    Returns CLh in mL/min/kg.
    """
    ratio = cl_int_scaled_mL_per_min_per_kg / qh_mL_per_min_per_kg if qh_mL_per_min_per_kg > 0.0 else 0.0
