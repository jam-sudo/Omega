...
class TestHygroscopicityScore:
    ...
    def test_high_drug_loading_adds_5(self):
        ...
        assert res_high_load.hygroscopicity_score == pytest.approx(
            res_low_load.hygroscopicity_score + 5.0
        )
...
class TestScreenFormulations:
    ...
    def test_sorted_ascending(self):
        forms = [
            ...
            self._make_dict(
                drug_name="Mid", logP=1.5, glass_transition_temp_C=75.0, storage_rh_pct=40.0
            ),
        ]
