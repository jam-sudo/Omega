...
class TestLogPEffects:
    ...
    def test_higher_logP_increases_cardiac_to_plasma_ratio(self, low_logp_result, high_logp_result):
        assert high_logp_result.cardiac_to_plasma_ratio > low_logp_result.cardiac_to_plasma_ratio
    ...
    def test_very_high_logP_gives_high_myopathy_or_cardiac_risk(self):
        ...
        risk_high = result.myopathy_risk == "high" or result.cardiac_exposure_risk == "high"
        assert risk_high
