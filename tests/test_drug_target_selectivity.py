...
def test_returns_correct_type():
    result = predict_target_selectivity("DrugA", "TargetX", 1.0, ["OffA", "OffB"], [100.0, 200.0])
...
def test_multiple_off_targets_min_si():
    result = predict_target_selectivity("DrugA", "T", 2.0, ["O1", "O2", "O3"], [20.0, 40.0, 10.0])
    # SIs: 10, 20, 5 → min=5
    assert math.isclose(result.minimum_selectivity_index, 5.0)
