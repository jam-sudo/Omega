...
def test_higher_koff2_lower_occupancy_at_24h():
    ...
    r_high_affinity = simulate_tissue_binding(drug_name="Drug", dose_mg=100.0, koff2=0.01)
    r_low_affinity = simulate_tissue_binding(drug_name="Drug", dose_mg=100.0, koff2=2.0)
