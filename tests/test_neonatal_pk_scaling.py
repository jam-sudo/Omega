...
class TestScaleNeonatalPK:
    def test_returns_result(self):
        result = scale_neonatal_pk("Drug", age_days=14, weight_kg=3.0,
                                   adult_cl_L_per_h=5.0, adult_vd_L=50.0)
        assert isinstance(result, NeonatalPKResult)

    def test_drug_name_preserved(self):
        result = scale_neonatal_pk("Amoxicillin", age_days=7, weight_kg=3.0,
                                   adult_cl_L_per_h=5.0, adult_vd_L=50.0)
        assert result.drug_name == "Amoxicillin"

    def test_age_days_preserved(self):
        result = scale_neonatal_pk("Drug", age_days=21, weight_kg=3.0,
                                   adult_cl_L_per_h=5.0, adult_vd_L=50.0)
        assert result.age_days == 21

    def test_weight_preserved(self):
        result = scale_neonatal_pk("Drug", age_days=14, weight_kg=3.5,
                                   adult_cl_L_per_h=5.0, adult_vd_L=50.0)
        assert result.weight_kg == 3.5

    def test_adult_cl_preserved(self):
        result = scale_neonatal_pk("Drug", age_days=14, weight_kg=3.0,
                                   adult_cl_L_per_h=8.0, adult_vd_L=50.0)
        assert result.adult_cl_L_per_h == 8.0

    def test_adult_vd_preserved(self):
        result = scale_neonatal_pk("Drug", age_days=14, weight_kg=3.0,
                                   adult_cl_L_per_h=5.0, adult_vd_L=100.0)
        assert result.adult_vd_L == 100.0

    def test_gfr_fraction_range(self):
        for age in [0, 7, 14, 28, 90, 180, 365]:
            result = scale_neonatal_pk("Drug", age_days=age, weight_kg=5.0,
                                       adult_cl_L_per_h=5.0, adult_vd_L=50.0)
    ...
    def test_gfr_increases_with_age(self):
        ...
        r1 = scale_neonatal_pk("Drug", age_days=1, weight_kg=3.0,
                                adult_cl_L_per_h=5.0, adult_vd_L=50.0)
        r2 = scale_neonatal_pk("Drug", age_days=180, weight_kg=3.0,
                                adult_cl_L_per_h=5.0, adult_vd_L=50.0)
    ...
    def test_cyp3a4_increases_with_age(self):
        r1 = scale_neonatal_pk("Drug", age_days=1, weight_kg=3.0,
                                adult_cl_L_per_h=5.0, adult_vd_L=50.0)
        r2 = scale_neonatal_pk("Drug", age_days=360, weight_kg=3.0,
                                adult_cl_L_per_h=5.0, adult_vd_L=50.0)
    ...
    def test_neonatal_cl_less_than_adult(self):
        ...
        result = scale_neonatal_pk("Drug", age_days=7, weight_kg=3.0,
                                   adult_cl_L_per_h=5.0, adult_vd_L=50.0,
    ...
    def test_protein_binding_adjustment_neonate(self):
        result = scale_neonatal_pk("Drug", age_days=0, weight_kg=3.0,
                                   adult_cl_L_per_h=5.0, adult_vd_L=50.0)
        assert result.protein_binding_adjustment < 1.0

    def test_protein_binding_adjustment_older_infant(self):
        result = scale_neonatal_pk("Drug", age_days=90, weight_kg=5.0,
                                   adult_cl_L_per_h=5.0, adult_vd_L=50.0)
        assert result.protein_binding_adjustment == 1.0
    ...
    def test_notes_very_early_neonate(self):
        result = scale_neonatal_pk("Drug", age_days=3, weight_kg=2.5,
                                   adult_cl_L_per_h=5.0, adult_vd_L=50.0)
    ...
    def test_validation_age_out_of_range(self):
        with pytest.raises(ValueError):
            scale_neonatal_pk("Drug", age_days=400, weight_kg=3.0,
                               adult_cl_L_per_h=5.0, adult_vd_L=50.0)

    def test_validation_negative_age(self):
        with pytest.raises(ValueError):
            scale_neonatal_pk("Drug", age_days=-1, weight_kg=3.0,
                               adult_cl_L_per_h=5.0, adult_vd_L=50.0)

    def test_validation_negative_weight(self):
        with pytest.raises(ValueError):
            scale_neonatal_pk("Drug", age_days=14, weight_kg=-1.0,
                               adult_cl_L_per_h=5.0, adult_vd_L=50.0)


class TestCompareAgeGroups:
    def test_default_ages(self):
        results = compare_age_groups("Drug", weight_kg=5.0,
                                     adult_cl_L_per_h=5.0, adult_vd_L=50.0)
