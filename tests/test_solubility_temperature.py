...
def test_acid_high_ph_higher_solubility():
    ...
    r_lo = predict_solubility_temperature(
        "Acid", 200.0, 1.5, 100.0, temperature_C=25.0, pka=5.0, ionization_type="acid", ph=3.0
    )
    r_hi = predict_solubility_temperature(
        "Acid", 200.0, 1.5, 100.0, temperature_C=25.0, pka=5.0, ionization_type="acid", ph=9.0
    )
