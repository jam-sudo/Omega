...
def test_fields_present():
    res = make_result()
    for field in [
        "drug_name", "dose_mg", "particle_size_nm",
        "times_h", "c_plasma_mg_L", "a_crystal_mg", "a_dissolved_mg",
        "cmax", "tmax_h", "auc", "f_dissolved_at_4h",
        "dissolution_t50_h", "enhancement_vs_bulk", "notes",
    ]:
