...
def test_cerebellum_enrichment_increases_auc():
    enriched = simulate_cerebellar_pk("Drug", 100.0, cerebellum_enrichment=2.0, cortex_enrichment=0.5)
...
def test_cerebellum_enrichment_increases_ratio_vs_cortex():
    enriched = simulate_cerebellar_pk("Drug", 100.0, cerebellum_enrichment=2.0, cortex_enrichment=0.8)
    # cortex_to_cerebellum_ratio should be lower when cerebellum is enriched more
    low_enrich = simulate_cerebellar_pk("Drug", 100.0, cerebellum_enrichment=0.5, cortex_enrichment=2.0)
