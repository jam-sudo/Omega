...
def test_spleen_eventually_falls():
    result = simulate_splenic_pk(
        "Drug", dose_mg=10.0, formulation_type="nanoparticle_100nm",
        t_end_h=48.0
    )
...
def test_cmax_spleen_positive():
    for formulation in ["small_molecule", "liposome", "nanoparticle_100nm",
...
def test_compare_all_formulations_present():
    ...
    expected = {
        "small_molecule", "liposome", "nanoparticle_100nm",
        "nanoparticle_50nm", "pegylated_nanoparticle"
    }
