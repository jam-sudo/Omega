...
def make_sim(
    t_lag_h=0.0, dose_mg=500.0, ka_per_h=1.5, cl_L_per_h=5.0, vd_L=20.0, f_oral=1.0, t_end_h=24.0
):
...
def test_compare_custom_lag_times():
    results = compare_lag_times("Drug", 500.0, 1.5, 5.0, 20.0, lag_times_h=[0.0, 1.0, 3.0])
