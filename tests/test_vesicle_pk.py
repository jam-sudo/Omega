...
def test_free_initial_value():
    ...
    ee = 0.8
    vd = 50.0
    result = simulate_vesicle_pk(
        "Drug", dose_mg=dose, encapsulation_efficiency=ee, vd_free_L=vd, t_end_h=72.0
    )
...
def test_cmax_gt_initial():
    result = simulate_vesicle_pk(
        "Drug", dose_mg=100.0, encapsulation_efficiency=0.95, cl_free_L_per_h=2.0, t_end_h=72.0
    )
