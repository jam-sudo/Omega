...
class TestCalculateWeightBasedDose:
    ...
    def test_max_cap_applied(self):
        res = calculate_weight_based_dose(
            "DrugA", dose_per_kg_mg=5.0, weight_kg=100.0, max_dose_mg=400.0
        )
    ...
    def test_min_cap_applied(self):
        res = calculate_weight_based_dose(
            "DrugA", dose_per_kg_mg=1.0, weight_kg=10.0, min_dose_mg=50.0
        )
    ...
    def test_exact_max_boundary_no_cap(self):
        ...
        res = calculate_weight_based_dose(
            "DrugA", dose_per_kg_mg=2.0, weight_kg=70.0, max_dose_mg=140.0
        )
        assert res.dose_capped is False
        assert res.cap_reason == "none"
...
class TestAllometricDoseAdjustment:
    def test_basic_scaling(self):
        ...
        res = allometric_dose_adjustment(
            "DrugB", reference_dose_mg=100.0, reference_weight_kg=70.0, patient_weight_kg=70.0
        )
    ...
    def test_higher_weight_higher_dose(self):
        res_light = allometric_dose_adjustment(
            "DrugB", reference_dose_mg=100.0, reference_weight_kg=70.0, patient_weight_kg=50.0
        )
        res_heavy = allometric_dose_adjustment(
            "DrugB", reference_dose_mg=100.0, reference_weight_kg=70.0, patient_weight_kg=90.0
        )
    ...
    def test_sub_proportional_scaling(self):
        ...
        res_ref = allometric_dose_adjustment(
            "DrugB", reference_dose_mg=100.0, reference_weight_kg=70.0, patient_weight_kg=70.0
        )
        res_2x = allometric_dose_adjustment(
            "DrugB", reference_dose_mg=100.0, reference_weight_kg=70.0, patient_weight_kg=140.0
        )
    ...
    def test_exponent_0_75_formula(self):
        ...
        res = allometric_dose_adjustment(
            "DrugB", reference_dose_mg=ref_dose, reference_weight_kg=ref_wt, patient_weight_kg=pt_wt
        )
    ...
    def test_no_cap_by_default(self):
        res = allometric_dose_adjustment(
            "DrugB", reference_dose_mg=100.0, reference_weight_kg=70.0, patient_weight_kg=200.0
        )
        assert res.dose_capped is False
    ...
    def test_validation_ref_weight_zero(self):
        with pytest.raises(ValueError):
            allometric_dose_adjustment(
                "DrugB", reference_dose_mg=100.0, reference_weight_kg=0.0, patient_weight_kg=70.0
            )

    def test_validation_patient_weight_zero(self):
        with pytest.raises(ValueError):
            allometric_dose_adjustment(
                "DrugB", reference_dose_mg=100.0, reference_weight_kg=70.0, patient_weight_kg=0.0
            )

    def test_intensity_100_no_cap(self):
        res = allometric_dose_adjustment(
            "DrugB", reference_dose_mg=100.0, reference_weight_kg=70.0, patient_weight_kg=80.0
        )
        assert res.dose_intensity_pct == pytest.approx(100.0)
...
class TestBodySurfaceAreaDose:
    def test_mosteller_bsa_calculation(self):
        ...
        res = body_surface_area_dose(
            "DrugC", dose_per_m2_mg=50.0, weight_kg=weight, height_cm=height
        )
    ...
    def test_max_cap_applied(self):
        res = body_surface_area_dose(
            "DrugC", dose_per_m2_mg=1000.0, weight_kg=70.0, height_cm=170.0, max_dose_mg=100.0
        )
        assert res.final_dose_mg == pytest.approx(100.0)
        assert res.dose_capped is True
        assert res.cap_reason == "max_exceeded"
