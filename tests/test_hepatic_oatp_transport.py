...
def test_screen_substrates_sorted_descending():
    ...
    results = screen_substrates(substrates, "Cyclosporine", ki_oatp_uM=0.5, perpetrator_cmax_uM=2.0)
...
def test_screen_substrates_returns_correct_count():
    ...
    results = screen_substrates(substrates, "Inhibitor", ki_oatp_uM=1.0, perpetrator_cmax_uM=1.0)
