...
def test_uv_lower_fraction_than_fluorescent():
    r_fl = predict_photodegradation("D", mw_Da=300.0, chromophore="aromatic", light_source="fluorescent")
...
def test_oxygen_reduces_fraction_remaining():
    ...
    r_o2 = predict_photodegradation(
        "D", mw_Da=300.0, chromophore="aromatic", oxygen_present=True
    )
