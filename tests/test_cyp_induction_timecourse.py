...
def test_strong_inducer_category():
    ...
    result = _default(
        inducer_conc_uM=100.0, ec50_uM=1.0, max_fold_induction=10.0,
        t_end_h=500.0
    )
...
def test_moderate_inducer_category():
    ...
    result = _default(
        inducer_conc_uM=100.0, ec50_uM=1.0, max_fold_induction=4.0,
        t_end_h=500.0
    )
...
def test_weak_inducer_category():
    ...
    result = _default(
        inducer_conc_uM=1.0, ec50_uM=5.0, max_fold_induction=2.0,
        t_end_h=500.0
    )
