...
def test_validation_dose_zero():
    with pytest.raises(ValueError, match="dose_mg"):
        simulate_lymphatic_pk(
            drug_name="X", dose_mg=0.0, route="subcutaneous",
            mw_kDa=1.0, logp=1.0, cl_sys_L_per_h=1.0, vd_sys_L=10.0
        )
...
def test_validation_invalid_route():
    with pytest.raises(ValueError, match="route"):
        simulate_lymphatic_pk(
            drug_name="X", dose_mg=10.0, route="intravenous",
            mw_kDa=1.0, logp=1.0, cl_sys_L_per_h=1.0, vd_sys_L=10.0
        )
...
def test_validation_cl_zero():
    with pytest.raises(ValueError, match="cl_sys_L_per_h"):
        simulate_lymphatic_pk(
            drug_name="X", dose_mg=10.0, route="subcutaneous",
            mw_kDa=1.0, logp=1.0, cl_sys_L_per_h=0.0, vd_sys_L=10.0
        )
...
def test_validation_vd_zero():
    with pytest.raises(ValueError, match="vd_sys_L"):
        simulate_lymphatic_pk(
            drug_name="X", dose_mg=10.0, route="subcutaneous",
            mw_kDa=1.0, logp=1.0, cl_sys_L_per_h=1.0, vd_sys_L=0.0
        )
