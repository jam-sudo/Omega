...
def test_higher_clint_gives_higher_clh():
    ...
    assert r_high.cl_hepatic_well_stirred_L_per_h_per_kg > r_low.cl_hepatic_well_stirred_L_per_h_per_kg
...
def test_fu_correction_effect():
    ...
    assert r_with_correction.cl_int_scaled_mL_per_min_per_kg > r_no_correction.cl_int_scaled_mL_per_min_per_kg
