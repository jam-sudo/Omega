...
def test_all_fields_present():
    ...
    for field in [
        "age_group", "body_weight_kg", "v_liver_L", "v_kidney_L",
        "cardiac_output_L_per_h", "q_liver_L_per_h", "q_kidney_L_per_h",
        "gfr_mL_per_min", "cyp3a4_activity_fraction", "ugt1a1_activity_fraction",
        "adult_cl_scaling_factor", "allometric_dose_factor", "notes",
    ]:
...
def test_v_liver_positive_all_groups():
    for ag in ["neonate", "infant_1_6mo", "infant_6_12mo",
...
def test_cyp3a4_increases_with_age():
    groups = ["neonate", "infant_1_6mo", "infant_6_12mo",
              "toddler_1_3y", "preschool_3_6y", "school_6_12y"]
