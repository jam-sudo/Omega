...
def test_larger_particle_size_increases_t50():
    r_small = predict_microencapsulation_pk("drug_j", mw_Da=300.0, logp=1.0, particle_size_um=20.0)
    r_large = predict_microencapsulation_pk("drug_j", mw_Da=300.0, logp=1.0, particle_size_um=200.0)
