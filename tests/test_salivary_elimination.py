...
def test_simulate_list_lengths_match():
    result = simulate_salivary_profile("X", 100.0, pka=7.0, ionization_type="base", t_end_h=6.0, dt_h=0.1)
...
def test_simulate_sp_ratio_matches_static():
    fu = 0.5
    pka = 8.0
    result_sim = simulate_salivary_profile("X", 100.0, pka=pka, ionization_type="base", fu_plasma=fu)
    result_static = predict_salivary_concentration("X", 1.0, pka=pka, ionization_type="base", fu_plasma=fu)
