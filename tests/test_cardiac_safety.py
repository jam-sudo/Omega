...
class TestQTRisk:
    def test_low_inhibition_low_qt_risk(self):
        ...
        r = assess_cardiac_safety(
            "safe", "C", herg_ic50_uM=1000.0, concentration_uM=1.0,
            logP=1.0, mw=200.0, daily_dose_mg=50.0,
        )
    ...
    def test_high_inhibition_high_qt_risk(self):
        ...
        r = assess_cardiac_safety(
            "risky", "C", herg_ic50_uM=0.01, concentration_uM=100.0,
            logP=4.0, mw=500.0, daily_dose_mg=1000.0,
        )
    ...
    def test_delta_qtc_proportional_to_inhibition(self):
        ...
        r = assess_cardiac_safety(
            "drug", "C", herg_ic50_uM=10.0, concentration_uM=10.0,
            logP=1.0, mw=200.0, daily_dose_mg=10.0,
        )
    ...
    def test_zero_concentration_zero_inhibition(self):
        r = assess_cardiac_safety(
            "drug", "C", herg_ic50_uM=10.0, concentration_uM=0.0,
        )
    ...
    def test_qt_categories_correct_boundaries(self):
        ...
        r_low = assess_cardiac_safety(
            "d", "C", herg_ic50_uM=1000.0, concentration_uM=0.01,
            logP=0.0, mw=100.0, daily_dose_mg=0.0,
        )
        assert r_low.qt_risk_category == "low"

    def test_critical_qt_risk(self):
        r = assess_cardiac_safety(
            "d", "C", herg_ic50_uM=0.001, concentration_uM=1000.0,
            logP=10.0, mw=200.0, daily_dose_mg=5000.0,
        )
...
class TestStructuralAlerts:
    def test_no_alerts_clean_smiles(self):
        r = assess_cardiac_safety(
            ...
            herg_ic50_uM=100.0, concentration_uM=0.1,
        )
    ...
    def test_tertiary_amine_alert_detected(self):
        # "N(C)(C)C" pattern
        r = assess_cardiac_safety(
            "tert_amine_drug", "CN(C)(C)CCc1ccccc1",
            herg_ic50_uM=100.0, concentration_uM=0.1,
        )
...
class TestInotropy:
    def test_low_inotropy_risk_low_logP(self):
        r = assess_cardiac_safety(
            "d", "C", herg_ic50_uM=100.0, concentration_uM=1.0,
            logP=1.0, mw=200.0,
        )
...
class TestMitigation:
    ...
    def test_cardiac_monitoring_required_for_high_qt(self):
        r = assess_cardiac_safety(
            "d", "C", herg_ic50_uM=0.01, concentration_uM=100.0,
            logP=4.0, mw=500.0, daily_dose_mg=1000.0,
        )
    ...
    def test_safety_pharmacology_required_above_50pct_inhibition(self):
        ...
        r = assess_cardiac_safety(
            "d", "C", herg_ic50_uM=5.0, concentration_uM=5.5,
            logP=1.0, mw=200.0, daily_dose_mg=10.0,
        )
