...
def test_double_bsa_double_dose():
    ...
    r1 = pediatric_dose_bsa("Drug", 200.0, weight_kg=7.5, height_cm=60.0, age_years=0.5, adult_bsa_m2=2.0)
    r2 = pediatric_dose_bsa("Drug", 200.0, weight_kg=30.0, height_cm=120.0, age_years=7.0, adult_bsa_m2=2.0)
