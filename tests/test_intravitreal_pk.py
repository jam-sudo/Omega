...
class TestPKBehaviour:
    def test_large_molecule_longer_half_life_than_small(self):
        r_large = simulate_intravitreal_pk("Large", 500.0, mw_kDa=48.0, t_end_h=720.0)
        r_small = simulate_intravitreal_pk("Small", 500.0, mw_kDa=0.5, t_end_h=720.0)
    ...
    def test_t_half_analytical(self):
        ...
        r = simulate_intravitreal_pk("Ranibizumab", 500.0, mw_kDa=48.0, logp=logp)
