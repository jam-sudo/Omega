...
class TestValidation:
    ...
    def test_invalid_ga_raises(self):
        with pytest.raises(ValueError, match="gestational_age_weeks"):
            simulate_placental_transfer(
                drug_name="X", dose_mg=10.0, gestational_age_weeks=15
            )
