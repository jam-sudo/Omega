...
class TestComputeTIInputValidation:
    ...
    def test_mec_zero(self):
        with pytest.raises(ValueError, match="MEC"):
            compute_therapeutic_index(_DRUG, _ED50, _TD50, _ED50_AUC, _TD50_AUC, (0.0, 5.0))

    def test_mtc_le_mec(self):
        with pytest.raises(ValueError, match="MTC"):
            compute_therapeutic_index(_DRUG, _ED50, _TD50, _ED50_AUC, _TD50_AUC, (5.0, 3.0))


class TestComputeTIResults:
    def setup_method(self):
        self.result = compute_therapeutic_index(_DRUG, _ED50, _TD50, _ED50_AUC, _TD50_AUC, _RANGE)
    ...
    def test_is_narrow_ti_true_for_narrow(self):
        result = compute_therapeutic_index(_DRUG, 10.0, 15.0, 10.0, 15.0, _RANGE)
...
class TestSimulateTIResults:
    def setup_method(self):
        self.result = simulate_ti_population(_DRUG, _ED50, _TD50, n_subjects=500, seed=123)
    ...
    def test_zero_cv_deterministic(self):
        r = simulate_ti_population(
            _DRUG, _ED50, _TD50, n_subjects=100, ed50_cv_pct=0.0, td50_cv_pct=0.0, seed=0
        )
    ...
    def test_default_dose_is_geometric_mean(self):
        ...
        r = simulate_ti_population(_DRUG, _ED50, _TD50, n_subjects=100, seed=0)
