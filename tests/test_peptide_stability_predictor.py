...
def test_cyclic_modifier_exact_5x():
    ...
    cyclic = base_predict(n_residues=5, d_aa_fraction=0.0, n_methylated_bonds=0, is_pegylated=False, is_cyclic=True)
...
def test_pegylation_modifier_exact_2x():
    base = base_predict(n_residues=5, d_aa_fraction=0.0, n_methylated_bonds=0, is_cyclic=False, is_pegylated=False)
    peg = base_predict(n_residues=5, d_aa_fraction=0.0, n_methylated_bonds=0, is_cyclic=False, is_pegylated=True)
...
def test_pegylation_prevents_agg_penalty():
    no_peg = base_predict(hydrophobic_pct=50.0, abs_charge=1.0, n_beta_residues=4, is_pegylated=False)
...
def test_unstable_class_short_half_life():
    ...
    res = base_predict(n_residues=20, d_aa_fraction=0.0, n_methylated_bonds=0, is_cyclic=False, is_pegylated=False)
...
def test_stable_class_long_half_life():
    ...
    res = base_predict(n_residues=5, d_aa_fraction=0.5, n_methylated_bonds=3, is_cyclic=True, is_pegylated=True)
