...
def test_high_pgp_substrate_high_bbb_risk():
    ...
    result = predict_efflux_transporters("HighPgp", logp=2.0, mw=500.0, hbd=3, hba=5)
...
def test_pgp_inhibitor_high_logp_base():
    result = predict_efflux_transporters("BaseHigh", logp=4.0, mw=550.0, ionization_type="base")
...
def test_neutral_drug_low_mate():
    result = predict_efflux_transporters("Neutral", logp=2.0, mw=400.0, ionization_type="neutral")
