...
def test_compare_hematocrit_returns_correct_length():
    ...
    results = compare_hematocrit_effect("Drug", logp=2.0, pka=7.0, ionization_type="neutral", hct_values=hct_values)
...
def test_compare_hematocrit_empty_list():
    results = compare_hematocrit_effect("Drug", logp=2.0, pka=7.0, ionization_type="neutral", hct_values=[])
    assert results == []
