...
COMBINED_PBPK_SIMULATION, sensitivity analysis, uncertainty propagation,
...
def evaluate_candidate(
    ...
    Returns:
        CandidateReport2 with all assessment metrics.
    """
    # 1. Baseline PK simulation
...
___all___ = ["CandidateReport2", "evaluate_candidate2"]
